  ...
  return useMutation({
    ...
    onSuccess: async (result, { data }) => {
      ...
      await Promise.all([
        ...
        queryClient.invalidateQueries({ queryKey: queryKeys.subjectOffers._def, refetchType: 'all' }), //REVIEW Ya ni me acuerdo porq ue invalidaba esto, en verdad es necesario? Capaz para cuando es especifica por trimestre por el tema de los stats
        queryClient.invalidateQueries({ queryKey: queryKeys.student.enrolledSubjects._def }),
      ]);
