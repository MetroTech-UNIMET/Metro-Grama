...
const cardVariants = cva(
  "rounded-xl border bg-white text-neutral-950 shadow-sm dark:bg-neutral-950 dark:text-neutral-50 px-4 py-2",
  {
    variants: {
      variant: {
        ...
        destructive: "bg-destructive/15 border-0 text-destructive ",
      },
    },
    defaultVariants: {
      variant: "default",
