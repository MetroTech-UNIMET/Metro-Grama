...
import type { Notification_FriendRequest } from '@/interfaces/Notifications';

interface Props extends React.HTMLAttributes<HTMLAnchorElement> {
  notification: Notification_FriendRequest;
}

export function NotificationFriendRequestItem({ notification, className, ...props }: Props) {
  const studentId = notification.extraData.sender.ID;
