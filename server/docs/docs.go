...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/DTO.UserLoginForm"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CareerCreateForm"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.CareerWithSubjects"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/DTO.BatchUpdateOffersRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/subjects/electives/": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Subject elective form",
                        "name": "subject",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/DTO.SubjectElectiveForm"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "DTO.BatchSubjectOfferChange": {
            ...
            "properties": {
                "add": {
                    "description": "List of Trimester IDs",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "DTO.BatchUpdateOffersRequest": {
            ...
            "properties": {
                "captcha": {
                    "description": "for reCAPTCHA validation",
                    "type": "string"
                },
                "changes": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/DTO.BatchSubjectOfferChange"
                    }
                }
            }
        },
        ...
        "careers.updateCareerWithSubjectsParam": {
            "type": "object",
            "required": [
                "newCareer",
                "oldCareer"
            ...
            "properties": {
                "newCareer": {
                    "$ref": "#/definitions/dto.CareerUpdateForm"
                },
                "oldCareer": {
                    "$ref": "#/definitions/dto.CareerWithSubjects"
                }
            ...
            "properties": {
                ...
                "subjects": {
                    ...
                    "items": {
                        "type": "array",
                        "items": {
                            "$ref": "#/definitions/dto.CreateCareerSubject"
                        }
                    }
                }
            }
        },
        "dto.CareerSubjectWithoutType": {
            "type": "object",
            "required": [
                "code",
                "name",
            ...
            "properties": {
                ...
                "subjects": {
                    ...
                    "additionalProperties": {
                        "type": "object",
                        "additionalProperties": {
                            "$ref": "#/definitions/dto.UpdateCareerSubject"
                        }
                    }
                }
            }
        },
        "dto.CareerWithSubjects": {
            "type": "object",
            "required": [
                "emoji",
                "id",
            ...
            "properties": {
                ...
                "subjects": {
                    ...
                    "items": {
                        "type": "array",
                        "items": {
                            "$ref": "#/definitions/dto.CareerSubjectWithoutType"
                        }
                    }
                }
            }
        },
        "dto.CreateCareerSubject": {
            "type": "object",
            "required": [
                "code",
                "name",
