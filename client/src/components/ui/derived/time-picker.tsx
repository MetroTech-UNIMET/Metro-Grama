// Modified from  https://github.com/huybuidac/shadcn-datetime-picker/blob/main/components/simple-time-picker.tsx
...
export interface TimePickerProps {
  ...
  disabled?: boolean;
  /** Render the picker in modal mode */
  modal?: boolean;
  /** Hide seconds selector and display */
  hideSeconds?: boolean;
  /** Disable selection of hours before/after given times */
  disableHours?: { before?: Date; after?: Date };
}
