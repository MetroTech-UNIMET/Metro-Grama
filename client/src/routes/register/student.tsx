...
function RegisterStudent() {
  return (
    <div className="text-UI-white relative min-h-svh overflow-hidden bg-[#0B1020]">
      ...
      <div className="absolute -left-20 top-16 h-56 w-56 rounded-full bg-[#FF9B54]/20 blur-3xl sm:h-72 sm:w-72" />
      <div className="absolute -right-16 top-1/3 h-64 w-64 rounded-full bg-secondary-500/15 blur-3xl sm:h-80 sm:w-80" />
      <div className="absolute -bottom-20 left-1/3 h-56 w-56 rounded-full bg-primary-500/20 blur-3xl sm:h-72 sm:w-72" />
